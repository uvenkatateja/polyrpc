...
- ✅ **Zero Runtime Dependencies** - Generated client is self-contained
- ✅ **tRPC-like Pattern** - `.query()` and `.mutate()` methods
- ✅ **Full Type Safety** - Autocomplete for all routes and models
- ✅ **Enums as Values** - Use `UserRole.ADMIN` directly
- ✅ **Path Parameters** - `py.users.get_user.query({ user_id: 1 })`
- ✅ **Request Body Detection** - Automatically typed from Pydantic models
- ✅ **Tree-Shakeable** - Unused routes removed by bundler
- ✅ **<50ms Generation** - Instant feedback on save
...
```
┌─────────────────┐     ┌──────────────────┐     ┌─────────────────┐
│  Python Files   │────▶│  Rust Sentinel   │────▶│  polyrpc.ts     │
│  (Pydantic)     │     │  (tree-sitter)   │     │  (Type-safe)    │
└─────────────────┘     └──────────────────┘     └─────────────────┘
        │                       │                        │
...
**[📚 Full Documentation](https://polyrpc.vercel.app)** | **[GitHub](https://github.com/uvenkatateja/polyrpc)**
