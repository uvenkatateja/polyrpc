      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-32">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full bg-blue-500/10 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm text-blue-400 border border-blue-500/20 mb-6 sm:mb-8"
          >
          ...
          {/* Subtitle */}
          <p className="mx-auto mt-4 sm:mt-6 max-w-2xl text-base sm:text-lg text-zinc-400 lg:text-xl px-4">
          ...
          <div className="mt-6 sm:mt-8 flex justify-center gap-4 sm:gap-8 text-center">
            <div>
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-400">&lt;50ms</div>
              <div className="text-xs sm:text-sm text-zinc-500">Parse time</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-400">0</div>
              <div className="text-xs sm:text-sm text-zinc-500">Build steps</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-purple-400">100%</div>
              <div className="text-xs sm:text-sm text-zinc-500">Type safe</div>
            </div>
          </div>
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
            <Link
              ...
              className="group w-full sm:w-auto flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-6 py-3 font-semibold text-white transition-all hover:bg-blue-700 hover:gap-3"
            >
              Get Started
            ...
            <Link
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-lg border border-zinc-700 bg-zinc-900 px-6 py-3 font-semibold text-white transition-all hover:bg-zinc-800"
            >
          ...
          >
            <div className="rounded-xl border border-zinc-800 bg-zinc-900 shadow-2xl glow overflow-hidden">
              <div className="flex items-center gap-2 border-b border-zinc-800 px-3 sm:px-4 py-2 sm:py-3">
                ...
                <span className="ml-2 text-xs sm:text-sm text-zinc-500">terminal</span>
              </div>
              <div className="p-3 sm:p-4 font-mono text-xs sm:text-sm overflow-x-auto">
                ...
                <div className="text-zinc-400 whitespace-nowrap">👁 Watching backend → frontend/src/polyrpc.d.ts</div>
